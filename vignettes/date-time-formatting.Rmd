...
time_data %>% 
  chartjs() %>% 
  cjs_add_bars(x = x_time, y = y_numbers) %>% 
  cjs_scale_time(id = 'x', time.unit = 'day', time.displayFormats = 'do LLL yyyy')
```
...
time_data %>% 
  chartjs() %>% 
  cjs_add_bars(x = x_time, y = y_numbers) %>% 
  cjs_scale_time(id = 'x', time.unit = 'day', time.displayFormats = 'EEEE')
```
...
time_data %>% 
  chartjs() %>% 
  cjs_add_bars(x = x_time, y = y_numbers) %>% 
  cjs_scale_time(id = 'x', time.unit = 'month', time.displayFormats = 'LLLL yyyy')
```
...
time_data2 %>% 
  chartjs() %>% 
  cjs_add_bars(x = x_time, y = y_numbers) %>% 
  cjs_scale_time(id = 'x', time.unit = 'hour')
```
...
time_data2 %>% 
  chartjs() %>% 
  cjs_add_bars(x = x_time, y = y_numbers) %>% 
  cjs_scale_time(id = 'x', time.unit = 'hour', time.displayFormats = 'HHmm')
```
...
time_data2 %>% 
  chartjs() %>% 
  cjs_add_bars(x = x_time, y = y_numbers) %>% 
  cjs_scale_time(id = 'x', time.unit = 'hour', time.displayFormats = 'h:mm a')
```
